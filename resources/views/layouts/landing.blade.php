...
<head>
    ...
    <link rel="icon" href="{{asset('public/assets/images/landing/landing_logo.webp')}}"
        type="image/x-icon" />
    ...
    <nav class="navbar navbar-expand-md navbar-light default">
        <div class="container">
            <a class="navbar-brand landing-logo" href="#">
                <img src="{{ asset(Storage::url('upload/logo/landing_logo.png')) }}"  style="height:50px;" alt="logo"
                    class="img-fluid " />
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-secondary" href="{{ route('member.register') }}">
                            {{ __('Get Started') }}
                        </a>
                    </li>
                </ul>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-xl-6">
                        <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            @else
                                {{ __(' Clublink SaaS - Membership Management Software') }}
                            @endif
                        </h1>
                        <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            @else
                                {{ __('Membership Management Software is a powerful tool designed to help organizations streamline and automate all aspects of managing their members.This software simplifies essential tasks such as member registration, renewals, payment processing, attendance tracking, events, and reporting.
                                                                                                                                ') }}
                            @endif
                        </h4>
                        @php
                        ...
                        <div class="mb-4 mb-lg-0 d-inline-flex align-items-center wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mb-0 text-start">
                                    ...
                                    @else
                                        {{ __(' Manage your business efficiently with our all-in-one solution designed for performance, security, and scalability.') }}
                                    @endif
                                </h5>
                            </div>
                        </div>
                                ...
                                <div class="card price-card ">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush product-list">
                                            ...
                                            <li class="list-group-item enable">{{ __('Membership Plan Limit') }}
                                                {{ $subscription->membership_plan_limit }}</li>
                    ...
                    <div class="col-11 col-md-9 col-lg-7 position-relative">
                        <div class="swiper app-slider">
                            <div class="swiper-wrapper">
                                ...
                                @else
                                    <div class="swiper-slide">
                                        <img src="{{ Storage::url('upload/homepage/1.png') }}" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            {{ __('Dashboard') }}
                                            <i class="ti ti-link"></i>
                                        </h3>
                                        <p>{{ __('Membership Management Software is a powerful tool designed to help organizations streamline and automate all aspects of managing their members.') }}

                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ Storage::url('upload/homepage/2.png') }}" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            {{ __('Member') }}
                                            <i class="ti ti-link"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <img src="{{ Storage::url('upload/homepage/3.png') }}" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            {{ __('Membership') }}
                                            <i class="ti ti-link"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <img src="{{ Storage::url('upload/homepage/4.png') }}" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            {{ __('Invoice') }}
                                            <i class="ti ti-link"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <img src="{{ Storage::url('upload/homepage/5.png') }}" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            {{ __('Event') }}
                                            <i class="ti ti-link"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <img src="{{ Storage::url('upload/homepage/6.png') }}" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            {{ __('Dashboard') }}
                                            <i class="ti ti-link"></i>
                            ...
                            @else
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body text-muted">
                                            {{ __(' Our software provides a range of features including automation tools,real-time analytics, cloud-based access, secure data storage, seamless integrations, and customizable solutions tailored to your business needs.') }}
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body text-muted">
                                            {{ __('Yes! Our platform is designed to be user-friendly and intuitive, so your team can get started quickly without a steep learning curve.') }}
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body text-muted">
                                            {{ __('Absolutely! Our software is built to easily integrate with your current tools and systems, making the transition seamless and efficient.') }}
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapse-four" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body text-muted">
                                            {{ __(' Yes! We offer 24/7 customer support. Our dedicated team is ready to assist you with any questions or issues you may have.') }}
                                        </div>
                                    </div>
                                </div>
                            @endif
