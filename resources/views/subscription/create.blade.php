...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group">
            {{Form::label('membership_plan_limit',__('Membership Plan Limit'),array('class'=>'form-label'))}}
            {{Form::number('membership_plan_limit',null,array('class'=>'form-control','placeholder'=>__('Enter membership plan limit'),'required'=>'required'))}}
        </div>
