                            ...
                            <div class="tab-content">
                                @if (Gate::check('manage account settings'))
                                    <div class="tab-pane {{ empty($activeTab) || $activeTab == 'user_profile_settings' ? ' active show ' : '' }}"
                                        ...
                                        <div class="row">
                                            <div class="{{ (\Auth::user()->type == 'member') ? 'col-md-3' : 'col-md-6' }}">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    {{ Form::label('name', __('Last Name'), ['class' => 'form-label']) }}
                                                    {{ Form::text('last_name', !empty($loginUser->members)?$loginUser->members->last_name :null, ['class' => 'form-control', 'placeholder' => __('Enter your last name'), 'required' => 'required']) }}
                                                </div>
                                            </div>
                                            @endif
                                            <div class="col-md-6">
                                ...
                                @if (Gate::check('manage company settings'))
                                    <div class="tab-pane {{ !empty($activeTab) && $activeTab == 'company_settings' ? ' active show ' : '' }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                {{ Form::label('payment_number_prefix', __('Payment Number Prefix'), ['class' => 'form-label']) }}
                                                {{ Form::text('payment_number_prefix', $settings['payment_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter payment number prefix')]) }}
                                            </div>
                                            <div class="form-group col-md-6">
