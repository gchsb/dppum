        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5><?php echo e(__('Add New Product')); ?></h5>
                </div>
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form id="product-form" action="<?php echo e(route('member-products.store')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Enter product name')); ?>" value="<?php echo e(old('product_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Enter category')); ?>" value="<?php echo e(old('category')); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="<?php echo e(__('Enter product description')); ?>"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Enter price')); ?>" step="0.01" min="0" value="<?php echo e(old('price')); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Enter quantity')); ?>" min="1" value="<?php echo e(old('quantity', 1)); ?>">
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Enter SKU')); ?>" value="<?php echo e(old('sku')); ?>">
                                <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp-new\www\dppum\resources\views/member-products/create.blade.php ENDPATH**/ ?>