                                            ...
                                            <td>
                                                <div class="cart-action">
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show Page')): ?>
                                                        <a class="avtar avtar-xs btn-link-warning avtar avtar-xs btn-link-warning text-warning customModal" data-bs-toggle="tooltip"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete Page')): ?>
                                                        ...
                                                        <a class=" avtar avtar-xs btn-link-danger avtar avtar-xs btn-link-danger text-danger confirm_dialog" data-bs-toggle="tooltip"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u821011235/domains/dppum.com/public_html/resources/views/Pages/index.blade.php ENDPATH**/ ?>