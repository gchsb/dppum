                                        ...
                                        <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td class="text-center">
                                                <?php switch($feature):
                                                    ...
                                                    <?php case (__('Membership Plan Limit')): ?>
                                                        <?php echo e($subscription->membership_plan_limit); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u821011235/domains/dppum.com/public_html/resources/views/subscription/index.blade.php ENDPATH**/ ?>