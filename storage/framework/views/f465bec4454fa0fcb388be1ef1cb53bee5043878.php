                            ...
                            <div class="tab-content">
                                <?php if(Gate::check('manage account settings')): ?>
                                    <div class="tab-pane <?php echo e(empty($activeTab) || $activeTab == 'user_profile_settings' ? ' active show ' : ''); ?>"
                                        ...
                                        <div class="row">
                                            <div class="<?php echo e((\Auth::user()->type == 'member') ? 'col-md-3' : 'col-md-6'); ?>">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <?php echo e(Form::label('name', __('Last Name'), ['class' => 'form-label'])); ?>

                                                    <?php echo e(Form::text('last_name', !empty($loginUser->members)?$loginUser->members->last_name :null, ['class' => 'form-control', 'placeholder' => __('Enter your last name'), 'required' => 'required'])); ?>
                                ...
                                <?php if(Gate::check('manage company settings')): ?>
                                    <div class="tab-pane <?php echo e(!empty($activeTab) && $activeTab == 'company_settings' ? ' active show ' : ''); ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('payment_number_prefix', __('Payment Number Prefix'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('payment_number_prefix', $settings['payment_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter payment number prefix')])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u821011235/domains/dppum.com/public_html/resources/views/settings/index.blade.php ENDPATH**/ ?>