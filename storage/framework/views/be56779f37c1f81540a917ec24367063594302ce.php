            ...
            <div class="col-sm-6 ms-auto my-1">
                <ul class="list-inline footer-link mb-0 justify-content-sm-end d-flex">
                    <?php $__currentLoopData = $DefaultCustomPage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="list-inline-item"><a href="<?php echo e(route('page', $item->slug)); ?>"
                                target="_blank"><?php echo e($item->title); ?></a></li>
                                ...
                                <div class="theme-color theme-font-style">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="layout_font"
                                            ...
                                            <?php echo e($settings['layout_font'] == 'Poppins' ? 'checked' : ''); ?>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="layout_font"
                                            id="layoutfontInter"
                                            <?php echo e($settings['layout_font'] == 'Inter' ? 'checked' : ''); ?> value="Inter"
...
<?php endif; ?>
<?php /**PATH /home/u821011235/domains/dppum.com/public_html/resources/views/admin/footer.blade.php ENDPATH**/ ?>