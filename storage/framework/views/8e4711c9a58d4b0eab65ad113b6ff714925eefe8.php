...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('public/assets/images/landing/landing_logo.webp')); ?>"
        type="image/x-icon" />
    ...
    <nav class="navbar navbar-expand-md navbar-light default">
        <div class="container">
            <a class="navbar-brand landing-logo" href="#">
                <img src="<?php echo e(asset(Storage::url('upload/logo/landing_logo.png'))); ?>"  style="height:50px;" alt="logo"
                    class="img-fluid " />
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-secondary" href="<?php echo e(route('member.register')); ?>">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-xl-6">
                        <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <?php else: ?>
                                <?php echo e(__(' Clublink SaaS - Membership Management Software')); ?>
                        ...
                        <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <?php else: ?>
                                <?php echo e(__('Membership Management Software is a powerful tool designed to help organizations streamline and automate all aspects of managing their members.This software simplifies essential tasks such as member registration, renewals, payment processing, attendance tracking, events, and reporting.
                                                                                                                                ')); ?>
                        ...
                        <div class="mb-4 mb-lg-0 d-inline-flex align-items-center wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h5 class="mb-0 text-start">
                                    ...
                                    <?php else: ?>
                                        <?php echo e(__(' Manage your business efficiently with our all-in-one solution designed for performance, security, and scalability.')); ?>
                            ...
                            <ul class="list-unstyled customize-list">
                                ...
                                <?php else: ?>
                                    <li>
                                        ...
                                        <?php echo e(__('Simplify and automate your business processes for maximum efficiency.')); ?>

                                    </li>
                                    <li>
                                        <i class="ti ti-circle-check f-20 text-secondary"></i>
                                        <?php echo e(__('Receive tailored strategies to meet business needs and unlock potential.')); ?>

                                    </li>
                                    <li>
                                        <i class="ti ti-circle-check f-20 text-secondary"></i>
                                        <?php echo e(__('Grow confidently with flexible solutions that adapt to your business needs.')); ?>

                                    </li>
                                    <li>
                                        <i class="ti ti-circle-check f-20 text-secondary"></i>
                                        <?php echo e(__('Make smarter decisions with real-time analytics and performance tracking.')); ?>

                                    </li>
                                    <li>
                                        <i class="ti ti-circle-check f-20 text-secondary"></i>
                                        <?php echo e(__('Rely on 24/7 expert assistance to keep your business running smoothly.')); ?>
                        ...
                        <?php if($is3 % 2 == 0): ?>
                            <div class="col-md-6 text-center mb-md-5">
                                <?php if(!empty($Section_1_content_value['Box' . $is3 . '_image_path'])): ?>
                                    <img src="<?php echo e(asset(Storage::url($Section_1_content_value['Box' . $is3 . '_image_path']))); ?>"
                                        alt="img" class="img-fluid w-75" />
                                <?php else: ?>
                                    <img src="assets/images/landing/img-customize-2.png" alt="img"
                                        class="img-fluid w-75" />
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                ...
                <div class="row g-4 text-center">
                    ...
                    <?php if($is4_check == 0): ?>
                        <div class="col-md-6 col-xl-4">
                            ...
                            <p>
                                <?php echo e(__('Simplify operations with an intuitive and easy-to-use platform.')); ?>
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <p>
                                <?php echo e(__('Automate repetitive tasks to save time and increase efficiency.')); ?>
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <p>
                                <?php echo e(__('Tailor features to fit your unique business needs and workflows.')); ?>
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <p>
                                <?php echo e(__('Grow your business with flexible solutions that scale with you.')); ?>
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <p>
                                <?php echo e(__('Protect your data with advanced encryption and security protocols.')); ?>
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <p>
                                <?php echo e(__('Gain actionable insights with live data tracking and reporting.')); ?>
                                ...
                                <div class="card price-card ">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush product-list">
                                            ...
                                            <li class="list-group-item enable"><?php echo e(__('Membership Plan Limit')); ?>

                                                <?php echo e($subscription->membership_plan_limit); ?></li>
                                            ...
                                            <?php else: ?>
                                                <li class="list-group-item"><?php echo e(__('Disable Coupon Applicable')); ?>
                                        ...
                                        <a class="btn btn-outline-primary bg-light text-primary mt-4"
                                            ...
                                            role="button"><?php echo e(__('Order Now')); ?></a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-11 col-md-9 col-lg-7 position-relative">
                        <div class="swiper app-slider">
                            <div class="swiper-wrapper">
                                ...
                                <?php else: ?>
                                    <div class="swiper-slide">
                                        <img src="<?php echo e(Storage::url('upload/homepage/1.png')); ?>" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                        ...
                                        <p><?php echo e(__('Membership Management Software is a powerful tool designed to help organizations streamline and automate all aspects of managing their members.')); ?>


                                    </div>
                                    <div class="swiper-slide">
                                        <img src="<?php echo e(Storage::url('upload/homepage/2.png')); ?>" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                    ...
                                    <div class="swiper-slide">
                                        <img src="<?php echo e(Storage::url('upload/homepage/3.png')); ?>" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                    ...
                                    <div class="swiper-slide">
                                        <img src="<?php echo e(Storage::url('upload/homepage/4.png')); ?>" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                    ...
                                    <div class="swiper-slide">
                                        <img src="<?php echo e(Storage::url('upload/homepage/5.png')); ?>" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            <?php echo e(__('Event')); ?>
                                    ...
                                    <div class="swiper-slide">
                                        <img src="<?php echo e(Storage::url('upload/homepage/6.png')); ?>" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            <?php echo e(__('Dashboard')); ?>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingOne">
                                        <button class="accordion-button text-muted" type="button"
                                            ...
                                            aria-expanded="false">
                                            <b><?php echo e(__('What features does your software offer?')); ?></b>
                                        </button>
                                    </h2>
                                    <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                        aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body text-muted">
                                            <?php echo e(__(' Our software provides a range of features including automation tools,real-time analytics, cloud-based access, secure data storage, seamless integrations, and customizable solutions tailored to your business needs.')); ?>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingTwo">
                                        <button class="accordion-button collapsed text-muted" type="button"
                                            ...
                                            <b><?php echo e(__('Is your software easy to use?')); ?></b>
                                        </button>
                                    </h2>
                                    <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body text-muted">
                                            <?php echo e(__('Yes! Our platform is designed to be user-friendly and intuitive, so your team can get started quickly without a steep learning curve.')); ?>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingThree">
                                        <button class="accordion-button collapsed text-muted" type="button"
                                            ...
                                            aria-expanded="false" aria-controls="flush-collapseThree">
                                            <b><?php echo e(__('Can I integrate your software with my existing systems?')); ?></b>
                                        </button>
                                    </h2>
                                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body text-muted">
                                            <?php echo e(__('Absolutely! Our software is built to easily integrate with your current tools and systems, making the transition seamless and efficient.')); ?>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingfour">
                                        <button class="accordion-button collapsed text-muted" type="button"
                                            ...
                                            aria-expanded="false" aria-controls="flush-collapseThree">
                                            <b><?php echo e(__('Is customer support available?')); ?></b>
                                        </button>
                                    </h2>
                                    <div id="flush-collapse-four" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingfour" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body text-muted">
                                            <?php echo e(__(' Yes! We offer 24/7 customer support. Our dedicated team is ready to assist you with any questions or issues you may have.')); ?>
                                    ...
                                    <div class="col-6 col-md-<?php echo e($footer_col); ?> wow fadeInUp"
                                        ...
                                        <ul class="list-unstyled footer-link">
                                            <?php if(!empty($active_footer_menu1)): ?>
                                                ...
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php else: ?>
                                                <li><a href="#" target="_blank"><?php echo e(__('Blog')); ?></a></li>
                                                <li><a href="#" target="_blank"><?php echo e(__('Documentation')); ?></a>
                                                </li>
                                                <li><a href="#" target="_blank"><?php echo e(__('ChangeLog')); ?></a></li>
                                                <li><a href="#" target="_blank"><?php echo e(__('Support')); ?></a></li>
                                            <?php endif; ?>
                                        </ul>
                                    </div>
                                <?php endif; ?>
...
<?php /**PATH D:\wamp-new\www\dppum\resources\views/layouts/landing.blade.php ENDPATH**/ ?>