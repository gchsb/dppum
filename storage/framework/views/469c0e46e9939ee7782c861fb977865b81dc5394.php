        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSaveWizard')); ?>">
            ...
            <div id="tab1content">
                ...
                <div class="form-group <?php echo e($errors->has('app_url') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="url" name="app_url" id="app_url" value="<?php echo e($path); ?>" placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_url_placeholder')); ?>" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u821011235/domains/dppum.com/public_html/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>